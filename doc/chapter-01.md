...
### 1.3.1 旧版接口：术语
- 在本规范 1.0 版本之前的规范草案（例如，参见[Virtio PCI 草案]）定义了驱动与设备之间类似但不同的接口。由于这些接口已被广泛采用，因此本规范包含了**可选**功能，以简化从这些旧版草案接口的过渡。
- 具体而言，设备和驱动**可以**支持：
...
- 在这种情况下，读者或许会发现，重点关注章节标题中带有“旧版接口”标签的部分会更有帮助。这些部分突出了自早期草案以来所做出的改动。
