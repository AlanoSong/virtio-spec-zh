...
#### 4.1.4.10 旧版接口：PCI 设备布局注意事项

#### 4.1.4.11 配备旧版驱动的非过渡设备：PCI 设备布局注意事项

##### 4.1.4.11.1 设备要求：配备旧版驱动的非过渡设备
- 对于在平台上已知存在具有相同 ID（包括 PCI 版本、设备和厂商 ID）的旧版设备的旧驱动的情况，非过渡设备**应该**采取以下步骤，以使旧版驱动在尝试驱动它们[设备]时能够顺利地报错：
